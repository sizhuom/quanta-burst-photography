function this = classic_nl_patch_flow(varargin)
%
...
error(nargchk(0, 1, length(varargin)));
  ...
  switch (length(varargin))
    case 0
      ...
      this.interpolation_method = 'cubic';      %'cubic', 'bi-linear
      ...
      this = class(this, 'classic_nl_patch_flow');         
      
    case 1
      if isa(varargin{1}, 'classic_nl_patch_flow')
        this = varargin{1};        
      else    
          this = classic_nl_patch_flow;
