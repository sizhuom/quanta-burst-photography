function [lin_srgb, nl_srgb] = raw_process_func(filename, read_app, bayer_type)
%RAW_PROCESS_FUNC function that reads and processes a RAW image file
% Based on Rob Sumner's script -- See below
%
