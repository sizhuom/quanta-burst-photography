...
param = struct(...
    ...
    'alignTWSize', 100, 'alignTWNum', 60,...
    'mergeTWSize', 100, 'mergeTWNum', 60, 'warpTWSize', 10,...
    'srTWSize', 100, 'srTWNum', 60,...
    'refFrame', calcRefFrame(100, 60),...
    ...% Parameters for align and merging, don't change for now
    'numLevels', 3, 'patchSizes', [8 8 8],...
...
%% Read images
tic;
imbs = ss2_1b_range_read(dataDir, 33950, 39949);
