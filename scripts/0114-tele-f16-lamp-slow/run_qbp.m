...
param = struct(...
    ...
    'alignTWSize', 1000, 'alignTWNum', 20,...
    'mergeTWSize', 1000, 'mergeTWNum', 20, 'warpTWSize', 10,...
    'srTWSize', 400, 'srTWNum', 50,...
    'refFrame', calcRefFrame(1000, 20),...
...
%% Read images
tic;
imbs = ss2_1b_range_read(dataDir, 56500, 76499);
