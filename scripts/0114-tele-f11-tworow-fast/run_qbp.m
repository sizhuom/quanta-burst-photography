...
param = struct(...
    ...
    'alignTWSize', 160, 'alignTWNum', 20,...
    'mergeTWSize', 160, 'mergeTWNum', 20, 'warpTWSize', 10,...
    'srTWSize', 40, 'srTWNum', 80,...
    'refFrame', calcRefFrame(160, 20),...
...
%% Read images
tic;
imbs = ss2_1b_range_read(dataDir, 75320, 78519);
